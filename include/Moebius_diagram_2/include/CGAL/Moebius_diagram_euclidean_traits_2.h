...
inline
CGAL::Orientation
moebius_orientation_2 (const Moebius_point_2<K,W> &p,
...
{
 public:
  typedef Moebius_point_2<K,W> Point;
...
inline
bool
moebius_has_circle_2 (const Moebius_point_2<K,W> &p,
		     const Moebius_point_2<K,W> &q,
		     Cartesian_tag)
{
  typedef typename K::RT RT;
...
inline
bool
moebius_circle_cross_line_2 (const Moebius_point_2<K,W> &p,
			    const Moebius_point_2<K,W> &q,
...
inline
CGAL::Oriented_side
moebius_circle_side_of_center_2 (const Moebius_point_2<K,W> &p,
				const Moebius_point_2<K,W> &q,
				const Moebius_point_2<K,W> &r,
				Cartesian_tag)
{
...
inline
CGAL::Bounded_side
moebius_side_of_vertex_2 (const Moebius_point_2<K,W> &p,
			 const Moebius_point_2<K,W> &q,
			 const Moebius_point_2<K,W> &r,
...
inline
CGAL::Oriented_side
moebius_circle_side_of_vertex_2 (const Moebius_point_2<K,W> &p,
				const Moebius_point_2<K,W> &q,
				const Moebius_point_2<K,W> &r,
				const Moebius_point_2<K,W> &s,
				Cartesian_tag)
...
inline
CGAL::Line_2<K>
moebius_line_2 (const Moebius_point_2<K,W> &p,
	       const Moebius_point_2<K,W> &q,
	       Cartesian_tag)
{
...
{
  typedef typename K::Rep_tag Tag;
  CGAL::Line_2<K> l = moebius_line_2 (p, q, Tag ());
  typename K::FT d (0);
  d += square (p.x() - q.x());
  d += square (p.y() - q.y());
  d += square (p.lambda() - q.lambda());
  d += square (p.mu() - q.mu());

  //TRACE ("moebius_line_2 [" << d << "] ("<<p<<","<<q<<") = "<<l<<"\n");
  CGAL_assertion ((&p) != (&q));
  CGAL_assertion (p.x() != q.x() || p.y() != q.y() || 
                   p.lambda() != q.lambda() ||
                   p.mu() != q.mu());
  return l;
}
...
{
 public:
  typedef CGAL::Moebius_point_2<K, W> Point;
  typedef CGAL::Line_2<K> Line;
...
inline
CGAL::Circle_2<K>
moebius_circle_2 (const Moebius_point_2<K,W> &p,
		 const Moebius_point_2<K,W> &q,
		 Cartesian_tag)
{
  typedef typename K::FT FT;
  ...
  CGAL::Orientation o = moebius_circleC2 (p.x(), p.y(), FT (p.lambda()), FT (p.mu()),
					 q.x(), q.y(), FT (q.lambda()), FT (q.mu()),
					 x, y, r);
  return Circle (typename K::Point_2 (x, y), r, o);
}
 ...
 public:
  ...
  result_type
    operator() (const Point &p,
		const Point &q) const
    { 
      return moebius_circle_2<K,W> (p, q);
    }
};
...
template <class K, class W, class Pair>
inline
Pair
moebius_circle_vertices_2 (const Moebius_point_2<K,W> &p,
			  const Moebius_point_2<K,W> &q,
			  const Moebius_point_2<K,W> &r,
			  Cartesian_tag)
{
  ...
  moebius_circle_verticesC2 (p.x(), p.y(), FT (p.lambda()), FT (p.mu()),
			    ...
			    x1, y1, x2, y2);
  return Pair (typename K::Point_2 (x1,y1), typename K::Point_2 (x2, y2));
}
...
{
  typedef typename K::Rep_tag Tag;
  return moebius_circle_vertices_2<K,W,Pair> (p, q, r, Tag ());
}
  ...
  result_type
    operator() (const Point &p,
		const Point &q,
    		const Point &r) const
    { 
      return moebius_circle_vertices_2<K,W,Pair> (p, q, r);
    }
};
...
inline
Pair
moebius_line_vertices_2 (const Moebius_point_2<K,W> &p,
			const Moebius_point_2<K,W> &q,
			const Moebius_point_2<K,W> &r,
			Cartesian_tag)
{
...
{
  typedef typename K::Rep_tag Tag;
  return moebius_line_vertices_2<K,W,Pair> (p, q, r, Tag ());
}
  ...
  result_type
    operator() (const Point &p,
		const Point &q,
    		const Point &r) const
    { 
      return moebius_line_vertices_2<K,W,Pair> (p, q, r);
    }
};
...
inline
typename K::Point_2
moebius_vertex_2 (const Moebius_point_2<K,W> &p,
		 const Moebius_point_2<K,W> &q,
		 const Moebius_point_2<K,W> &r,
		 Cartesian_tag)
{
...
class Moebius_construct_vertex_2
{
 public:
  typedef CGAL::Moebius_point_2<K, W> Point;
  typedef /* blip blop */ typename K::Point_2 result_type;
...
inline
typename K::Point_2
moebius_regular_circumcenter_2 (const Moebius_point_2<K,W> &p,
			       const Moebius_point_2<K,W> &q,
			       const Moebius_point_2<K,W> &r,
			       const Moebius_point_2<K,W> &s,
			       Cartesian_tag)
...
: public K
{
 public:
  ...
  typedef Moebius_point_2<K, Weight> Point_2;
  ...
  typedef CGAL::Moebius_orientation_2<K,Weight> Moebius_orientation_2;
  typedef CGAL::Moebius_has_circle_2<K,Weight> Moebius_has_circle_2;
  typedef CGAL::Moebius_circle_cross_line_2<K,Weight> Moebius_circle_cross_line_2;
  typedef CGAL::Moebius_circle_side_of_center_2<K,Weight> Moebius_circle_side_of_center_2;
  typedef CGAL::Moebius_side_of_vertex_2<K,Weight> Moebius_side_of_vertex_2;
  typedef CGAL::Moebius_circle_side_of_vertex_2<K,Weight> Moebius_circle_side_of_vertex_2;

  typedef CGAL::Moebius_construct_line_2<K,Weight> Moebius_construct_line_2;
  typedef CGAL::Moebius_construct_circle_2<K,Weight> Moebius_construct_circle_2;

  //typedef CGAL::Moebius_construct_regular_circum_center_2<K,Weight> Moebius_construct_regular_circum_center_2;
  typedef CGAL::Moebius_construct_circle_vertices_2<K,Weight,Segment_2> Moebius_construct_circle_vertices_2;
  typedef CGAL::Moebius_construct_line_vertices_2<K,Weight,Segment_2> Moebius_construct_line_vertices_2;
  typedef CGAL::Moebius_construct_vertex_2<K,Weight> Moebius_construct_vertex_2;
